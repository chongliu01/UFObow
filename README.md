Otsu_ For_ Cell.m is used to segment sliced images into cells, while removeLargeArea.m is an additional defined function to ensure the normal operation of the segmentation code. 
